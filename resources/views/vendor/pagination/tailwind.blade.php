    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden">
            @if ($paginator->onFirstPage())
                ...
                dark:bg-gray-800 dark:text-gray-700 dark:border-gray-700
            ...
            @if ($paginator->hasMorePages())
                <a href="{{ $paginator->nextPageUrl() }}" class="relative inline-flex items-center px-4 py-2 ml-3
                ...
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    ...
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            ...
                            bg-white border border-gray-300
                            dark:bg-gray-800 dark:text-gray-700 dark:border-gray-700
                            cursor-default rounded-l-md leading-5" aria-hidden="true">
                    ...
                    @else
                        <a href="{{ $paginator->previousPageUrl() }}" rel="prev" class="relative inline-flex items-center px-2 py-2
                        text-sm font-medium text-gray-500
                        bg-white border border-gray-300
                        dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700
                        rounded-l-md leading-5 hover:text-gray-400
                    ...
                    @if ($paginator->hasMorePages())
                        ...
                        bg-white border border-gray-300
                        dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700
                        rounded-r-md leading-5 hover:text-gray-400
                        focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300
                        active:bg-gray-100 active:text-gray-500
